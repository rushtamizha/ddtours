        ...
        <div className="flex justify-between items-center px-5 ">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-semibold tracking-tight leading-none text-[#0c4878]">
                DD TOURS AND TRAVELS
              </span>
              <span className="text-[9px] font-semibold tracking-[0.3em] uppercase text-[#189da3]">
          ...
          <div className="hidden lg:flex items-center gap-1">
            {navLinks.map((link) => (
              <Link 
                key={link.name} 
                href={link.href} 
                className={`px-5 py-2 text-[13px] font-semibold rounded-full transition-all hover:bg-[#0c4878]/5 ${
                  scrolled ? 'text-[#0c4878]' : 'text-[#0c4878]'
                }`}
              >
                {link.name}
              </Link>
            ...
            <button
              ...
              className={`ml-4 px-7 py-2.5 bg-[#189da3] text-white rounded-full text-[13px] font-semibold shadow-lg hover:shadow-[#0c4878]/30 active:scale-95 transition-all`}
            >
              ENQUIRE
            </button>
          </div>
          ...
          <button 
            ...
            className="lg:hidden p-2.5 rounded-full bg-[#0c4878]/5 text-[#0c4878] transition-all active:scale-90"
          >
          ...
          {isOpen && (
            ...
            >
              <div className="p-4 flex flex-col gap-1">
                {navLinks.map((link, i) => (
                  ...
                  >
                    ...
                    >
                      <div className="w-12 h-12 shrink-0 flex items-center justify-center rounded-xl bg-[#0c4878]/5 text-[#0c4878] group-hover:bg-[#189da3] group-hover:text-white transition-all">
                        {React.cloneElement(link.icon, { size: 22 })}
                      </div>
                      <div className="flex-1 text-left">
                        <p className="text-[15px] font-semibold text-[#0c4878] leading-tight">{link.name}</p>
              ...
              <div className="p-4 bg-gray-50/50 border-t border-gray-100">
                <button 
                  onClick={handleWhatsApp}
                  className="w-full py-4 bg-[#0c4878] text-white rounded-2xl font-semibold flex items-center justify-center gap-3 shadow-xl active:scale-[0.98] transition-all"
                >
                  <RiWhatsappLine size={20} className="text-[#189da3]" />
