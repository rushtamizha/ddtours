        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-4">
            <motion.span
              ...
              className="text-[#189da3] font-semibold uppercase tracking-[0.3em] text-[11px]"
            >
              Guest Experiences
            </motion.span>
            <h2 className="text-4xl md:text-4xl font-semibold text-[#0c4878] mt-4 leading-tight">
            ...
            <div className="mt-10 flex items-center gap-4 p-5 bg-white rounded-3xl border border-gray-100 shadow-sm w-fit">
              ...
              <div>
                <p className="text-[#0c4878] font-semibold text-sm">
                  4.9/5 Rating
                </p>
              ...
              {reviews.map((review, index) => (
                <SwiperSlide key={index}>
                  <motion.div className="bg-white p-10 rounded-[3rem] shadow-xs border border-gray-50 h-full relative m-2">
                    <RiDoubleQuotesR className="absolute top-8 right-10 text-gray-100 text-4xl -z-0" />
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-[#0c4878] font-medium leading-relaxed  mb-8">
                        "{review.text}"
                      </p>

                      <div className="flex items-center gap-4 pt-6 border-t border-gray-50">
                        <div className="w-12 h-12 rounded-2xl bg-[#0c4878]/5 flex items-center justify-center text-[#0c4878] font-semibold">
                          {review.name.charAt(0)}
                        </div>
                        <div>
                          <div className="flex items-center gap-2">
                            <h4 className="font-semibold text-[#0c4878] text-[15px]">
                              {review.name}
                            </h4>
                            <RiCheckboxCircleFill
                          ...
                          <p className="text-[11px] text-[#189da3] font-semibold uppercase tracking-widest">
                            {review.location}
                          </p>
                        </div>
                      </div>
